...
import 'adm_endereco_model.dart';
export 'adm_endereco_model.dart';

class AdmEnderecoWidget extends StatefulWidget {
  const AdmEnderecoWidget({super.key});

  @override
  State<AdmEnderecoWidget> createState() => _AdmEnderecoWidgetState();
}

class _AdmEnderecoWidgetState extends State<AdmEnderecoWidget> {
  late AdmEnderecoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdmEnderecoModel());
                          ...
                          Flexible(
                            child: Container(
                              ...
                              child: TextFormField(
                                ...
                                keyboardType: TextInputType.emailAddress,
                                validator: _model.nomeTextController7Validator
                                    .asValidator(context),
                              ),
                            ),
                          ),
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              context.pushNamed('AdmFormacaoCTT');
                            },
                            text: 'Próximo',
