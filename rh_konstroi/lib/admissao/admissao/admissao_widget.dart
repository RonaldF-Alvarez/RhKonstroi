...
import 'admissao_model.dart';
export 'admissao_model.dart';

class AdmissaoWidget extends StatefulWidget {
  const AdmissaoWidget({super.key});

  @override
  State<AdmissaoWidget> createState() => _AdmissaoWidgetState();
}

class _AdmissaoWidgetState extends State<AdmissaoWidget> {
  late AdmissaoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdmissaoModel());
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        Flexible(
                                          child: FlutterFlowDropDown<String>(
                                            controller: _model
                                                    .dropDownEstadoCivilValueController ??=
                                                FormFieldController<String>(
                                                    null),
                                            options: [
                                              'Solteiro',
                                            ...
                                            onChanged: (val) async {
                                              safeSetState(() => _model
                                                      .dropDownEstadoCivilValue =
                                                  val);
                                              FFAppState()
                                                      .PreAdmissaoEstadoCivil =
                                                  _model
                                                      .dropDownEstadoCivilValue!;
                                              safeSetState(() {});
                                            },
                                ...
                                Flexible(
                                  child: Padding(
                                    ...
                                    child: Container(
                                      width: double.infinity,
                                      child: TextFormField(
                                        controller: _model.nomeTextController7,
                                        focusNode: _model.nomeFocusNode7,
                                        autofocus: true,
                                        autofillHints: [AutofillHints.email],
                                        obscureText: false,
                                        decoration: InputDecoration(
                                ...
                                Flexible(
                                  child: Padding(
                                    ...
                                    child: Container(
                                      width: double.infinity,
                                      child: TextFormField(
                                        controller: _model.nomeTextController8,
                                        focusNode: _model.nomeFocusNode8,
                                        autofocus: true,
                                        autofillHints: [AutofillHints.email],
                                        obscureText: false,
                                        decoration: InputDecoration(
